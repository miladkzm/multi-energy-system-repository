...
def set_figure_art(fontsize=10):
    # fontsize = 7
    linewidth = 0.4
    linewidth_lines = 1
    usetex=True
    matplotlib.rc('legend', fontsize=fontsize*7/10, handlelength=3)
    ...
    matplotlib.rc('xtick', labelsize=fontsize*8/10)
    matplotlib.rc('xtick.major', width=0.4)
    matplotlib.rc('ytick.major', width=0.4)
    matplotlib.rc('ytick', labelsize=fontsize*8/10)
