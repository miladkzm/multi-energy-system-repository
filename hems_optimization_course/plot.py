...
def step_plot(df: Union[pd.DataFrame, pd.Series] = None, df2: pd.Series = None, title: str = '', left_y_label: str = '', right_y_label: str = ''):
    ...
    colors = {
        ...
        'Heat': 'red',
        'Gas': 'green',
        'ev_power_charged': 'blue',
        'ev_power_discharged': 'red',
        'ev_soe': 'green',
        'storage_charging_power': 'blue',
        'storage_discharging_power': 'red',
        'ess_soe': 'green',
        'thermal_storage_charging_power': 'blue',
        'thermal_storage_discharging_power': 'red',
        'thermal_storage_soe': 'green',
        'p_buy': 'blue',
        'p_sell': 'red',
        'p_import': 'blue',
        'p_export': 'red',
